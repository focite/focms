...
class GeneratorCommand extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        foreach ($tables as $item) {
            ...
            if (isset($this->mapperTable[$table])) {
                $table = $this->mapperTable[$table];
            }
    ...
    private function entity($entity, $table, $database): void
    {
        ...
        $info = DB::query("select COLUMN_NAME,DATA_TYPE,COLUMN_COMMENT from information_schema.COLUMNS where table_name = '{$table}' and table_schema = '{$database}';");
