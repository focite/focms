        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item user">
                ...
                <dl class="layui-nav-child">
                    <dd><a user-menu-url="{:route('console/user/profile')}" user-menu-id="5555" user-menu-title="基本资料">基本资料</a></dd>
...
<!-- 依 赖 脚 本 -->
<script src="https://cdn.jsdelivr.net/gh/focite/layui-admin@master/component/layui/layui.js"></script>
<script src="https://cdn.jsdelivr.net/gh/focite/layui-admin@master/component/pear/pear.js"></script>
<!-- 框 架 初 始 化 -->
<script>
    layui.use(['admin','jquery','popup','drawer'], function() {
        ...
        admin.setConfigPath("static/admin/config.yml");
